 ...
 export default function GalleryClient({ initialCode }: GalleryClientProps) {
       ...
       const res = await fetch('/api/testimonials/add', {
         ...
         body: JSON.stringify({
           testimonial: {
             ...
             project: gallery.reservation.prestation_type || gallery.reservation.prestationType,
           },
           verificationCode: gallery.reservation.gallery_code || gallery.reservation.galleryCode,
         }),
       });
       ...
       <div className="max-w-6xl mx-auto px-4 py-8">
         <div className="mb-8">
           ...
           <p className="text-stone-600 mt-2">
             {gallery.reservation.first_name || gallery.reservation.firstName}{' '}
             {gallery.reservation.last_name || gallery.reservation.lastName} -{' '}
             {gallery.reservation.prestation_type || gallery.reservation.prestationType}
           </p>
